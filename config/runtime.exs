...
config :partpicker, PartpickerWeb.Endpoint,
  url: [scheme: "https", host: "partpicker.fly.dev", port: 443],
  http: [
    :inet6,
...
config :partpicker, PartpickerWeb.OAuth.Discord,
  url: "https://partpicker.fly.dev/oauth/discord",
  client_id: discord_client_id,
  client_secret: discord_client_secret

config :partpicker, Partpicker.Builds.Photo, root_path: "/photos"

config :partpicker, Partpicker.Library.Repo, database: "/photos/library.db"
