defmodule PartpickerWeb.OAuth.Discord do
  @client_id Application.get_env(:partpicker, __MODULE__)[:client_id]
  @client_secret Application.get_env(:partpicker, __MODULE__)[:client_secret]
  @url Application.get_env(:partpicker, __MODULE__)[:url]
  @url ||
    Mix.raise("""
